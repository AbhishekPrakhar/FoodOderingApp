...
const RestaurantCard = ({
    ...
    return (
        <div className='my-6 mx-8 rounded-xl shadow-lg w-[265px] hover:bg-gray-100 hover:scale-95 scale-100 ease-out duration-150 cursor-pointer'>
            <img className='rounded-t-xl' src={CDN_URL+imageID} alt="res_img" />
            <div className='p-2'>

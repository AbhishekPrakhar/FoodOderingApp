...
const RestaurantCard = ({
    ...
    return (
        <div className='m-6 rounded-xl shadow-lg w-[265px] hover:bg-gray-100 hover:scale-95 scale-100 ease-out duration-150 cursor-pointer'>
